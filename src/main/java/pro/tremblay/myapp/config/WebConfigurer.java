package pro.tremblay.myapp.config;
...
import pro.tremblay.myapp.web.filter.CachingHttpHeadersFilter;
import pro.tremblay.myapp.web.filter.StaticResourcesProductionFilter;
import pro.tremblay.myapp.web.filter.gzip.GZipServletFilter;
